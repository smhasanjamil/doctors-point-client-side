...
const Home = () => {
  return (
    <>
            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text_para">
                  ...
                  Natus necessitatibus fugit ex praesentium exercitationem modi
                  repudiandae earum recusandae eligendi minus!
                </p>
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                ...
                <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
                  <img src={avatorIcon} alt="avatorIcon" />
      ...
      {/* our great doctro section start ======= */}
      <section>
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            ...
            <p className="text_para text-center">
              ...
              dolore, in eaque ipsa rerum veniam?
            </p>
          </div>
